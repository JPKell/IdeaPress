# IdeaPress — Local Documentation

**This is a curated copy**, not the source of truth. It was generated from the suite's central
`ai-suite-docs` repository so that `ideapress` can be read, reviewed and implemented **without**
...
- [api.md](apps/ideapress/api.md)
- [data-model.md](apps/ideapress/data-model.md)
- [development-plan.md](apps/ideapress/development-plan.md)
- [risks.md](apps/ideapress/risks.md)
- [spec.md](apps/ideapress/spec.md)
- [workflows.md](apps/ideapress/workflows.md)
...
### Application this component calls over HTTP (never imports)
- [loadcoach/spec.md](apps/loadcoach/spec.md) — the HTTP contract this component calls over the network, never imports
- [loadcoach/api.md](apps/loadcoach/api.md) — the HTTP contract this component calls over the network, never imports
- [loadcoach/routing.md](apps/loadcoach/routing.md) — the HTTP contract this component calls over the network, never imports
